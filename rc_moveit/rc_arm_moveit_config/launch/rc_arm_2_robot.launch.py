...
def generate_launch_description():
    declared_arguments = [
        ...
        DeclareLaunchArgument('use_tf_target_bridge', default_value='false', description='是否启动 TF->Pose 目标桥接（放在 rc_moveit 中订阅 TF）'),
        ...
        DeclareLaunchArgument('mujoco_bridge_rate', default_value='200.0', description='MuJoCo 桥接循环频率（Hz）'),
