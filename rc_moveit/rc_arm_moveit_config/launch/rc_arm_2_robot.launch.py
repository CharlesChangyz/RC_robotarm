...
def generate_launch_description():
    declared_arguments = [
        ...
        DeclareLaunchArgument('position_print_topic', default_value='/rc_arm_2/feedback_joint_states', description='角度打印订阅话题（JointState.position）'),
        ...
        DeclareLaunchArgument('use_dm_serial', default_value='false', description='是否启动 dmbot_serial 的 USB2CANFD 驱动节点'),
