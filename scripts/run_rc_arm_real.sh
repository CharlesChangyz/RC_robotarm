...
TARGET_POSE_EXECUTOR_REPORT_LABEL="${TARGET_POSE_EXECUTOR_REPORT_LABEL:-real}"
...
echo "[run_rc_arm_real] target_pose_executor_report_enabled=${TARGET_POSE_EXECUTOR_REPORT_ENABLED}"
echo "[run_rc_arm_real] target_pose_executor_report_dir=${TARGET_POSE_EXECUTOR_REPORT_DIR}"
