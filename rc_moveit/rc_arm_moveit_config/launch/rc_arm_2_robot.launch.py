...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument('target_pose_executor_vel_scale', default_value='0.9', description='MoveIt 速度缩放（0~1）'),
        DeclareLaunchArgument('target_pose_executor_acc_scale', default_value='0.9', description='MoveIt 加速度缩放（0~1）'),
