...
def generate_launch_description():
    declared_arguments = [
        ...
        DeclareLaunchArgument('max_velocity', default_value='20.0', description='S 曲线最大速度（rad/s）'),
        DeclareLaunchArgument('max_acceleration', default_value='10.0', description='S 曲线最大加速度（rad/s^2）'),
        DeclareLaunchArgument('max_jerk', default_value='60.0', description='S 曲线最大加加速度（rad/s^3）'),
        ...
        DeclareLaunchArgument('low_stiffness_kp_j1', default_value='1.5', description='j1 低刚度模式位置增益覆盖（0 表示使用全局 low_stiffness_kp）'),
        DeclareLaunchArgument('low_stiffness_kd_j1', default_value='1.0', description='j1 低刚度模式阻尼增益覆盖（0 表示使用全局 low_stiffness_kd）'),
        DeclareLaunchArgument('low_stiffness_kp_j2', default_value='20.0', description='j2 低刚度模式位置增益覆盖（0 表示使用全局 low_stiffness_kp）'),
        DeclareLaunchArgument('low_stiffness_kd_j2', default_value='4.0', description='j2 低刚度模式阻尼增益覆盖（0 表示使用全局 low_stiffness_kd）'),
        DeclareLaunchArgument('low_stiffness_kp_j3', default_value='10.0', description='j3 低刚度模式位置增益覆盖（0 表示使用全局 low_stiffness_kp）'),
        DeclareLaunchArgument('low_stiffness_kd_j3', default_value='2.0', description='j3 低刚度模式阻尼增益覆盖（0 表示使用全局 low_stiffness_kd）'),
        DeclareLaunchArgument('low_stiffness_kp_j4', default_value='5.0', description='j4 低刚度模式位置增益覆盖0.035（0 表示使用全局 low_stiffness_kp）'),
        DeclareLaunchArgument('low_stiffness_kd_j4', default_value='1.0', description='j4 低刚度模式阻尼增益覆盖0.04（0 表示使用全局 low_stiffness_kd）'),
