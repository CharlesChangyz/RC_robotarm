...
echo "[run_rc_arm_mujoco] use_camera_target_point_bridge=${USE_CAMERA_TARGET_POINT_BRIDGE}"
echo "[run_rc_arm_mujoco] middleware_target_point_topic=${MIDDLEWARE_TARGET_POINT_TOPIC}"
echo "[run_rc_arm_mujoco] camera_target_point_input_topic=${CAMERA_TARGET_POINT_INPUT_TOPIC}"
echo "[run_rc_arm_mujoco] camera_target_point_output_topic=${CAMERA_TARGET_POINT_OUTPUT_TOPIC}"
echo "[run_rc_arm_mujoco] camera_target_point_source_frame=${CAMERA_TARGET_POINT_SOURCE_FRAME}"
